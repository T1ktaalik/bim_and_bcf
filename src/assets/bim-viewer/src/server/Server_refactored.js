...
class Server {
     ...
     * @param {String} [cfg.projectsPath] Base path for projects (default: "/projects").
     */
    constructor(cfg = {}) {
        this._dataDir = cfg.dataDir || "";
        this._projectsPath = cfg.projectsPath || "/projects"; // Путь можно переопределить
    }
    ...
    getProjects(done, error) {
        const url = this._dataDir + this._projectsPath + "/index.json";
    ...
    getProject(projectId, done, error) {
        const url = this._dataDir + this._projectsPath + "/" + projectId + "/index.json";
        utils.loadJSON(url, done, error);
    }
    ...
    getMetadata(projectId, modelId, done, error) {
        const url = this._dataDir + this._projectsPath + "/" + projectId + "/models/" + modelId + "/metadata.json";
        utils.loadJSON(url, done, error);
    }
    ...
    getGeometry(projectId, modelId, done, error) {
        const url = this._dataDir + this._projectsPath + "/" + projectId + "/models/" + modelId + "/geometry.xkt";
    ...
    getObjectInfo(projectId, modelId, objectId, done, error) {
        const url = this._dataDir + this._projectsPath + "/" + projectId + "/models/" + modelId + "/props/" + objectId + ".json";
        utils.loadJSON(url, done, error);
    }
    ...
    getIssues(projectId, modelId, done, error) {
        const url = this._dataDir + this._projectsPath + "/" + projectId + "/models/" + modelId + "/issues.json";
        utils.loadJSON(url, done, error);
    }
    ...
    getSplitModelManifest(projectId, modelId, manifestName, done, error) {
        const url = this._dataDir + this._projectsPath + "/" + projectId + "/models/" + modelId + "/" + manifestName;
        utils.loadJSON(url, done, error);
    }
    ...
    getSplitModelMetadata(projectId, modelId, metadataFileName, done, error) {
        const url = this._dataDir + this._projectsPath + "/" + projectId + "/models/" + modelId + "/" + metadataFileName;
        utils.loadJSON(url, done, error);
    }
    ...
    getSplitModelGeometry(projectId, modelId, geometryFileName, done, error) {
        const url = this._dataDir + this._projectsPath + "/" + projectId + "/models/" + modelId + "/" + geometryFileName;
        utils.loadArraybuffer(url, done, error);
    }
}
